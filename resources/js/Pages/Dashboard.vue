  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12">
      ...
      <div class="m-5 overflow-hidden border border-gray-200 rounded-lg shadow-md">
       <div class="px-5 py-3">
           <Link :href="route('offres.create')" class="px-10 py-2 text-white bg-indigo-500 rounded-xl"  >
               Ajouter
           </Link>
       </div>
        <table class="w-full text-sm text-left text-gray-500 bg-white border-collapse">
          ...
          <tbody class="border-t border-gray-100 divide-y divide-gray-100">
            <tr class="hover:bg-gray-50"  v-for="item in offres" >
              ...
              <td class="px-6 py-4">
                <div class="flex justify-end gap-4">
                    ...
                    <Link :href="route('offres.destroy', item.id)" method="delete" >
                        <svg
